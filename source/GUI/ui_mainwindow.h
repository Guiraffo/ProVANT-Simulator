...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton->setGeometry(QRect(730, 340, 181, 41));
        ...
        pushButton_2->setGeometry(QRect(730, 390, 181, 41));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_2->setText(QApplication::translate("MainWindow", "Initial values of joints", 0));
