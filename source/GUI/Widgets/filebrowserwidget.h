...
class FileBrowserWidget : public QWidget
{
  ...
  Q_PROPERTY(QString browserDialogCaption READ browserDialogCaption WRITE
                 setBrowserDialogCaption)
  Q_PROPERTY(QString browserDir READ browserDir WRITE setBrowserDir)
  Q_PROPERTY(QString fileFilter READ fileFilter WRITE setFileFilter)
  Q_PROPERTY(QString browserButtonTooltip READ browserButtonTooltip WRITE
                 setBrowserButtonTooltip)
