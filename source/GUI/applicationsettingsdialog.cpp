...
ApplicationSettingsDialog::ApplicationSettingsDialog(QWidget* parent)
  : QDialog(parent), ui(new Ui::ApplicationSettingsDialog)
{
  ui->setupUi(this);
  ...
  ui->provantROSWidget->setToolTip(tr("Path to the directory containing the "
                                      "catkin workspace "
                                      "source files. This directory is usually "
                                      "the \"src\" "
                                      "directory inside your catkin "
                                      "workspace."));
  ...
  ui->tiltStrategiesWidget->setToolTip(tr("Path to the directoy containing the "
                                          "compiled binaries of "
                                          "the  controllers. This directory is "
                                          "usually inside the "
                                          "catkin workspace in the "
                                          "\"devel/lib\" directory."));
  ...
  ui->tiltProjectWidget->setToolTip(tr("Path to the root directory of the "
                                       "Provant Simulator "
                                       "files. This directory is usually "
                                       "inside the \"src/ "
                                       "ProVANT-Simulator\" directory in your "
                                       "catkin workspace."));
  ...
  ui->tiltMatlabWidget->setToolTip(tr("Path to directory containing the files "
                                      "necessary to export "
                                      "the logs of the controller excecution "
                                      "to a Matlab file "
                                      "format. Usually this directory is "
                                      "inside the path to the "
                                      "\"TILT_PROJECT\" diretory under "
                                      "\"source/Structure/"
                                      "Matlab\""));
  ...
  ui->provantDatabaseWidget->setToolTip(tr("Path to the directory containing "
                                           "the database ROS package "
                                           "provided with the Provant "
                                           "Simulator. Usually this "
                                           "directory is inside the path to "
                                           "the \"TILT_PROJECT\" "
                                           "directory under "
                                           "\"source/Database/\""));
  ...
  ui->gazeboModelWidget->setToolTip(tr("Path to the directory which contains "
                                       "the "
                                       "simulator models. This directory is "
                                       "usually inside the "
                                       "path to \"PROVANT_DATABSE\" directory "
                                       "under \"models/\"."));
  ...
  ui->dirRosWidget->setToolTip(tr("Path to your catkin workspace."));
  ...
  ui->controlStrategiesSourceWidget->setBrowserDialogCaption(tr("Control "
                                                                "Strategies "
                                                                "Source"));
  ui->controlStrategiesSourceWidget->setBrowserType(
      FileBrowserWidget::Directory);
  ui->controlStrategiesSourceWidget->setToolTip(tr("Path to the directory "
                                                   "which contains the source "
                                                   "files to "
                                                   "all of the control "
                                                   "strategies that can be "
                                                   "used in the "
                                                   "simulator. This directory "
                                                   "is usually inside the path "
                                                   "to "
                                                   "\"%1\" under "
                                                   "\"/source/Structure/"
                                                   "control_strategies/\".")
  ...
  ui->rosPathWidget->setToolTip(tr("Path to the directory which contains the "
                                   "installation "
                                   "of ROS. This directory is usually inside "
                                   "/opt/ros/"
                                   "<ros_version>/"));
  ...
  ui->rosVersionWidget->addItem("noetic");
  ...
  ui->rosVersionWidget->setToolTip(tr("The ROS version used to run the "
                                      "simulator."));
}
 ...
 */
void ApplicationSettingsDialog::showErrorOnSettingMessage(
    const QString& key) const
{
  QMessageBox::critical(nullptr, tr("Error when setting the %1 path").arg(key),
