...
std::string Material::GetEmissive(){return emissive;}
std::string Material::GetDiffuse(){return diffuse;}
std::string Material::GetSpecular(){return specular;}
std::string Material::GetAmbient(){return ambient;}
void Material::SetEmissive(std::string value){emissive = value;}
void Material::SetDiffuse(std::string value){diffuse = value;}
void Material::SetSpecular(std::string value){specular = value;}
void Material::SetAmbient(std::string value){ambient = value;}
