...
std::string Inertial::GetPose(){return pose;}
std::string Inertial::GetMass(){return mass;}
std::string Inertial::GetIxx(){return ixx;}
std::string Inertial::GetIxy(){return ixy;}
std::string Inertial::GetIxz(){return ixz;}
std::string Inertial::GetIyy(){return iyy;}
std::string Inertial::GetIyz(){return iyz;}
std::string Inertial::GetIzz(){return izz;}
void Inertial::SetPose(std::string value){pose = value;}
void Inertial::SetMass(std::string value){mass = value;}
void Inertial::SetIxx(std::string value){ixx = value;}
void Inertial::SetIxy(std::string value){ixy = value;}
void Inertial::SetIxz(std::string value){ixz = value;}
void Inertial::SetIyy(std::string value){iyy = value;}
void Inertial::SetIyz(std::string value){iyz = value;}
void Inertial::SetIzz(std::string value){izz = value;}
