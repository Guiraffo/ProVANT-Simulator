...
{
  min = document->firstChildElement("sonar").firstChildElement("min").text();
  max = document->firstChildElement("sonar").firstChildElement("max").text();
  radius =
      document->firstChildElement("sonar").firstChildElement("radius").text();
}
