...
private:
  ...
  std::string link_name_;     // nome do elo correspondente ao corpo principal
  std::string link_right_;    // nome do elo correspondente ao motor brushless direito
  std::string link_left_;     // nome do elo correspondente ao motor brushless esquerdo
  ...
  // dados de simulação
  double x, y, z, roll, pitch, yaw, gama1, gama2, alphar, alphal, vx, vy, vz, wx, wy, wz, dalphar, dalphal, dgama1,
      dgama2;
  // sinais de entrada
  double Fr, Fl, Tr, Tl;
  MatlabData file;
