...
Frame::Frame()
	: _header(0x7E),_end(0x7E),_escape(0x7D), _cksum(0), _complete(false),
	_status(false)
{
	_buffer = NULL;
...
u8 Frame::header() {return this->_header;}
u8 Frame::end() {return this->_end;}
u8 Frame::escape() {return this->_escape;}
i32 Frame::size() {return this->_data_size;}
u8 *Frame::buffer() {return this->_buffer;}
i32 Frame::buffer_size() {return this->_buffer_size;}
u8 *Frame::data() {return this->_data;}
...
void Frame::setHeader(u8 header) {this->_header = header;}
void Frame::setEnd(u8 end)  {this->_end = end;}
void Frame::setEscape(u8 escape) {this->_escape = escape;}
void Frame::setSize(i32 size) {this->_buffer_size = size;}
