  ...
  try
  {
    ...
    else
    {
      ...
      if (tilt_matlab_env != NULL)
      {
        ...
        GeneralizedCoordinatesNVelocities.startFile(GeneralizedCoordinatesNVelocitiesFile, "GeneralizedCoordinatesNVelo"
                                                                                           "ci"
                                                                                           "ties");
        ...
        GeneralizedVelocitiesExpressedOnbodyFrame.startFile(GeneralizedVelocitiesExpressedOnbodyFrameFile, "Generalized"
                                                                                                           "Ve"
                                                                                                           "locitiesExp"
                                                                                                           "re"
                                                                                                           "ssedOnbodyF"
