...
namespace gazebo
{
	...
	class DataSaveTiltRotor : public ModelPlugin
	{
		...
		public: void CallbackRotr(std_msgs::Float64); // callback to saturate and save deflection at right rotor
		public: void CallbackRotl(std_msgs::Float64); // callback to saturate and save deflection at left rotor
		...
		private:
			...
			MatlabData2 FrFile;
			MatlabData2 FlFile;
			MatlabData2 RotrFile;
			MatlabData2 RotlFile;
			MatlabData2 DArFile;
			MatlabData2 DAlFile;
			MatlabData2 DRrFile;
			MatlabData2 DRlFile;
