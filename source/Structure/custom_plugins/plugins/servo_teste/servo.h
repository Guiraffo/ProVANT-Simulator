...
namespace gazebo
{
	...
	class Servo3MotorPlugin : public ModelPlugin
	{
		public: Servo3MotorPlugin(); 
  		public:virtual ~Servo3MotorPlugin(); 
		...
		private:  
			...
			std::string NameOflinkchild_;
			std::string NameOflinkparent_;
			...
			physics::LinkPtr linkparent; 
			physics::LinkPtr linkchild;  
