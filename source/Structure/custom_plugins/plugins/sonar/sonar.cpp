 ...
 * Version: 1.0
 * Date: 29/01/18
 * Description:  This library is responsable to implement a servo motor. It works in Torque mode or Position mode and
 * returns values of angular position and angular velocity
 */
