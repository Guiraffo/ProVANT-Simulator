...
void Model::ToTreeWidget(QTreeWidget* root)
{
    ...
    for(uint i = 0; i < links.size(); i++)
    {
        ...
        edit = TreeItens::AddChild(element,"Mass [kg]",links.at(i).inertialValues.GetMass().c_str());
        ...
        edit = TreeItens::AddChild(element,"ixx",links.at(i).inertialValues.GetIxx().c_str());
        edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
        edit = TreeItens::AddChild(element,"ixy",links.at(i).inertialValues.GetIxy().c_str());
        edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
        edit = TreeItens::AddChild(element,"ixz",links.at(i).inertialValues.GetIxz().c_str());
        edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
        edit = TreeItens::AddChild(element,"iyy",links.at(i).inertialValues.GetIyy().c_str());
        edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
        edit = TreeItens::AddChild(element,"iyz",links.at(i).inertialValues.GetIyz().c_str());
        edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
        edit = TreeItens::AddChild(element,"izz",links.at(i).inertialValues.GetIzz().c_str());
        edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
    ...
    for(uint i = 0; i < plugins.size(); i++)
    {
        ...
        {
            edit = TreeItens::AddChild(element,plugins.at(i).parameters.at(j),plugins.at(i).values.at(j));
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
        }
    }
    ...
    for(uint i = 0; i < sensors.size(); i++)
    {
        ...
        edit = TreeItens::AddChild(element,"Pose","");
        splitvector(sensors.at(i).pose.toStdString(),edit,true);
        edit = TreeItens::AddChild(element,"Update_rate",sensors.at(i).update_rate.toStdString());
        edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
        edit = TreeItens::AddChild(element,"Topic",sensors.at(i).topic.toStdString());
        edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
        if(sensors.at(i).name=="sonar")
        {
            edit = TreeItens::AddChild(element,"Max",sensors.at(i).max.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(element,"Min",sensors.at(i).min.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(element,"Radius",sensors.at(i).radius.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
        }
        if(sensors.at(i).name=="imu")
        {
            ...
            edit = TreeItens::AddChild(accelx,"type",sensors.at(i).accel_x.type.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(accelx,"mean",sensors.at(i).accel_x.mean.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(accelx,"stddev",sensors.at(i).accel_x.stddev.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(accelx,"bias mean",sensors.at(i).accel_x.bias_mean.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(accelx,"bias stddev",sensors.at(i).accel_x.bias_stddev.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(accelx,"precision",sensors.at(i).accel_x.precision.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            QTreeWidgetItem* accely = TreeItens::AddChild(accel,"y","");
            edit = TreeItens::AddChild(accely,"type",sensors.at(i).accel_y.type.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(accely,"mean",sensors.at(i).accel_y.mean.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(accely,"stddev",sensors.at(i).accel_y.stddev.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(accely,"bias mean",sensors.at(i).accel_y.bias_mean.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(accely,"bias stddev",sensors.at(i).accel_y.bias_stddev.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(accely,"precision",sensors.at(i).accel_y.precision.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            QTreeWidgetItem* accelz = TreeItens::AddChild(accel,"z","");
            edit = TreeItens::AddChild(accelz,"type",sensors.at(i).accel_z.type.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(accelz,"mean",sensors.at(i).accel_z.mean.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(accelz,"stddev",sensors.at(i).accel_z.stddev.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(accelz,"bias mean",sensors.at(i).accel_z.bias_mean.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(accelz,"bias stddev",sensors.at(i).accel_z.bias_stddev.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(accelz,"precision",sensors.at(i).accel_z.precision.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            QTreeWidgetItem* ang = TreeItens::AddChild(element,"Angular","");
            QTreeWidgetItem* angx = TreeItens::AddChild(ang,"x","");
            edit = TreeItens::AddChild(angx,"type",sensors.at(i).ang_x.type.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(angx,"mean",sensors.at(i).ang_x.mean.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(angx,"stddev",sensors.at(i).ang_x.stddev.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(angx,"bias mean",sensors.at(i).ang_x.bias_mean.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(angx,"bias stddev",sensors.at(i).ang_x.bias_stddev.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(angx,"precision",sensors.at(i).ang_x.precision.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            QTreeWidgetItem* angy = TreeItens::AddChild(ang,"y","");
            edit = TreeItens::AddChild(angy,"type",sensors.at(i).ang_y.type.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(angy,"mean",sensors.at(i).ang_y.mean.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(angy,"stddev",sensors.at(i).ang_y.stddev.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(angy,"bias mean",sensors.at(i).ang_y.bias_mean.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(angy,"bias stddev",sensors.at(i).ang_y.bias_stddev.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(angy,"precision",sensors.at(i).ang_y.precision.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            QTreeWidgetItem* angz = TreeItens::AddChild(ang,"z","");
            edit = TreeItens::AddChild(angz,"type",sensors.at(i).ang_z.type.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(angz,"mean",sensors.at(i).ang_z.mean.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(angz,"stddev",sensors.at(i).ang_z.stddev.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(angz,"bias mean",sensors.at(i).ang_z.bias_mean.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(angz,"bias stddev",sensors.at(i).ang_z.bias_stddev.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(angz,"precision",sensors.at(i).ang_z.precision.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
        }
        if(sensors.at(i).name=="gps")
        {
            ...
            edit = TreeItens::AddChild(pos_hor,"type",sensors.at(i).pos_horizontal.type.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(pos_hor,"mean",sensors.at(i).pos_horizontal.mean.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(pos_hor,"stddev",sensors.at(i).pos_horizontal.stddev.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(pos_hor,"bias mean",sensors.at(i).pos_horizontal.bias_mean.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(pos_hor,"bias stddev",sensors.at(i).pos_horizontal.bias_stddev.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(pos_hor,"precision",sensors.at(i).pos_horizontal.precision.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);

            QTreeWidgetItem* pos_ver = TreeItens::AddChild(pos,"vertical","");
            edit = TreeItens::AddChild(pos_ver,"type",sensors.at(i).pos_vertical.type.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(pos_ver,"mean",sensors.at(i).pos_vertical.mean.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(pos_ver,"stddev",sensors.at(i).pos_vertical.stddev.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(pos_ver,"bias mean",sensors.at(i).pos_vertical.bias_mean.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(pos_ver,"bias stddev",sensors.at(i).pos_vertical.bias_stddev.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(pos_ver,"precision",sensors.at(i).pos_vertical.precision.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);


            QTreeWidgetItem* vel = TreeItens::AddChild(element,"velocity sensing","");
            QTreeWidgetItem* vel_hor = TreeItens::AddChild(vel,"horizontal","");
            edit = TreeItens::AddChild(vel_hor,"type",sensors.at(i).vel_horizontal.type.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(vel_hor,"mean",sensors.at(i).vel_horizontal.mean.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(vel_hor,"stddev",sensors.at(i).vel_horizontal.stddev.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(vel_hor,"bias mean",sensors.at(i).vel_horizontal.bias_mean.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(vel_hor,"bias stddev",sensors.at(i).vel_horizontal.bias_stddev.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(vel_hor,"precision",sensors.at(i).vel_horizontal.precision.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);

            QTreeWidgetItem* vel_ver = TreeItens::AddChild(vel,"vertical","");
            edit = TreeItens::AddChild(vel_ver,"type",sensors.at(i).vel_vertical.type.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(vel_ver,"mean",sensors.at(i).vel_vertical.mean.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(vel_ver,"stddev",sensors.at(i).vel_vertical.stddev.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(vel_ver,"bias mean",sensors.at(i).vel_vertical.bias_mean.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(vel_ver,"bias stddev",sensors.at(i).vel_vertical.bias_stddev.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(vel_ver,"precision",sensors.at(i).vel_vertical.precision.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
        }
        if(sensors.at(i).name=="magnetometer")
        {
            QTreeWidgetItem* X = TreeItens::AddChild(element,"x","");
            edit = TreeItens::AddChild(X,"type",sensors.at(i).x.type.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(X,"mean",sensors.at(i).x.mean.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(X,"stddev",sensors.at(i).x.stddev.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(X,"bias mean",sensors.at(i).x.bias_mean.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(X,"bias stddev",sensors.at(i).x.bias_stddev.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(X,"precision",sensors.at(i).x.precision.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);

            QTreeWidgetItem* Y = TreeItens::AddChild(element,"y","");
            edit = TreeItens::AddChild(Y,"type",sensors.at(i).y.type.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(Y,"mean",sensors.at(i).y.mean.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(Y,"stddev",sensors.at(i).y.stddev.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(Y,"bias mean",sensors.at(i).y.bias_mean.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(Y,"bias stddev",sensors.at(i).y.bias_stddev.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(Y,"precision",sensors.at(i).y.precision.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);

            QTreeWidgetItem* Z = TreeItens::AddChild(element,"z","");
            edit = TreeItens::AddChild(Z,"type",sensors.at(i).z.type.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(Z,"mean",sensors.at(i).z.mean.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(Z,"stddev",sensors.at(i).z.stddev.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(Z,"bias mean",sensors.at(i).z.bias_mean.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(Z,"bias stddev",sensors.at(i).z.bias_stddev.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
            edit = TreeItens::AddChild(Z,"precision",sensors.at(i).z.precision.toStdString());
            edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
        }
    }
}
...
void Model::splitvector(std::string data,QTreeWidgetItem* Element,bool editable)
{
    if(data != "")
    {
        ...
        if(editable)edit->setFlags(Qt::ItemIsEditable|Qt::ItemIsEnabled);
